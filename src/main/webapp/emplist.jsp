...
<html>
	  ...
	  <style type="text/css">
			*{margin:0;padding:0;}
			...
			/*r_dao start*/
			.content .c_right .r_dao .d_list{height:99px;float:left;margin-left:1%;margin-top:20px;}
			.content .c_right .r_dao .d_1{width:22%;background:#27a9e3;}
			.content .c_right .r_dao .d_2{width:16%;background:#28b779;}
			.content .c_right .r_dao .d_3{width:17%;background:#ffb848;}
			.content .c_right .r_dao .d_4{width:21%;background:#cc6a6a;}
			.content .c_right .r_dao .d_5{width:18%;background:#2255a4;}
			.content .c_right .r_dao .d_6{width:17%;background:#da542e;}
			.content .c_right .r_dao .d_7{width:20%;background:#2255a4;}
			.content .c_right .r_dao .d_8{width:18%;background:#6297bc;}
			.content .c_right .r_dao .d_9{width:20%;background:#27a9e3;}
			.content .c_right .r_dao .d_10{width:19%;background:#28b779;}
			.content .c_right .r_dao .d_list:hover{background:#2f3437;}
			.content .c_right .r_dao .d_list .l_pic{background:url("../imgs/backCenter/ht_icon.png") no-repeat;width:44px;height:46px;float:left;margin:25px 10px 0 20px;}
			.content .c_right .r_dao .d_list .l_desc{color:#fff;margin-top:25px;}
			.content .c_right .r_dao .d_list .l_desc span{font-size:24px;}
			.content .c_right .r_dao .d_1 .l_pic{background-position:0 -76px;}
			.content .c_right .r_dao .d_2 .l_pic{background-position:-46px -77px;}
			.content .c_right .r_dao .d_3 .l_pic{background-position:-96px -77px;}
			.content .c_right .r_dao .d_4 .l_pic{background-position:-146px -77px;}
			.content .c_right .r_dao .d_5 .l_pic{background-position:-190px -77px;}
			.content .c_right .r_dao .d_6 .l_pic{background-position:-239px -77px;}
			.content .c_right .r_dao .d_7 .l_pic{background-position:-288px -77px;}
			.content .c_right .r_dao .d_8 .l_pic{background-position:-342px -77px;}
			.content .c_right .r_dao .d_9 .l_pic{background-position:-395px -77px;}
			.content .c_right .r_dao .d_10 .l_pic{background-position:-449px -77px;}
			/*end r_dao*/
					...
					<table class="t_tab">
						<thead>
							<tr>
								...
								<td>爱好</td>
								<td>部门</td>
								<shiro:hasPermission name="user:write">
									<td>操作</td>
								</shiro:hasPermission>
							</tr>
						</thead>
						...
						<c:forEach var="userInfo" items="${userInfo}">
							<tr>
								...
								<shiro:hasPermission name="user:write">
									<td class="t_td">
										<div class="t_action">
											<a href="${pageContext.request.contextPath }/user/empEdit?id=${userInfo.user.id }" class="a_edit" title="编辑"></a>
